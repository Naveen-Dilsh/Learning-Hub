 ...
 * @param {string} options.certificateUrl - Permanent URL to download the certificate (app download endpoint, not an expiring presigned URL)
 * @param {string} options.dashboardUrl - Optional URL to the student's certificates page
...
export async function sendCertificateEmail({
  ...
  try {
    const mailOptions = {
      from: `"ePencil Academy" <${process.env.GMAIL_USER}>`,
      to,
            ...
            <div class="container">
              ...
              <div class="content">
                ...
                <p style="font-size: 14px; color: #757575; margin-top: 20px;">
                  You may be asked to sign in to your account first. This link does not expire.
                </p>
                ...
                ${dashboardUrl ? `
                <p style="font-size: 14px; color: #757575;">
                  You can also download your certificate anytime from
                  <a href="${dashboardUrl}" style="color: #1976D2;">your certificates page</a>.
                </p>
                ` : ""}
              </div>
              <div class="footer">
                <p>Best regards,<br><strong>ePencil Academy Team</strong></p>
      ...
      text: `
        ...
        Download your certificate (sign in required, link does not expire): ${certificateUrl}
        ${dashboardUrl ? `Or visit your certificates page: ${dashboardUrl}` : ""}

        Best regards,
        ePencil Academy Team
      `,
    }
...
export async function sendPasswordResetEmail({ to, name, resetUrl }) {
  ...
  try {
    const mailOptions = {
      from: `"ePencil Academy" <${process.env.GMAIL_USER}>`,
      to,
      subject: "🔒 Reset Your ePencil Academy Password",
      html: `
        <!DOCTYPE html>
        <html>
          <head>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                ...
                <p>We received a request to reset the password for your ePencil Academy account.</p>
