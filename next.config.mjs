        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://*.cloudflarestream.com https://api.cloudflare.com https://*.gateway.api.cloudflare.com https://upload.imagedelivery.net https://upload.videodelivery.net https://*.r2.cloudflarestorage.com wss://*.cloudflarestream.com",
